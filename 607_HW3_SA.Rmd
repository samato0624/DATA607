...
"(.).\\1.\\1" - This expression will find a 4 character string where positions 1, 3, & 4 are any of the same character and position 2 is any character, i.e. "b ab<a.aa>b race..carara< k  >kl <....>".  
